...
function mega_scripts() {
	global $get_template_directory_uri;
		...
		wp_enqueue_style( 'mega-fancy', $get_template_directory_uri.'/libs/@fancyapps/fancybox/jquery.fancybox.min.css' );
		wp_enqueue_style( 'mega-main', $get_template_directory_uri.'/main.css' );
	...
	wp_enqueue_script( 'mega-Popup', $get_template_directory_uri . '/libs/@fancyapps/fancybox/jquery.fancybox.min.js', array('jquery'), '20200325', true );
	// wp_enqueue_script( 'mega-slider', $get_template_directory_uri . '/public/libs/swiper/js/swiper.min.js', array('jquery'), '20200325', true );
	...
	// wp_enqueue_script( 'mega-inputmask', $get_template_directory_uri . '/public/libs/inputmask/jquery.inputmask.min.js', array('jquery'), '20200325', true );
	...
	wp_enqueue_script( 'commont', $get_template_directory_uri . '/js/common.js', array('jquery'), '20200325', true );
